...
def main(args = None):
    ...
    if (args.save_model):
        torch.save(model.state_dict(),"mnist_%2.1f_%.4f_%s_%s_%d_%.2f_%.2f.pt"%(test_acc*100,args.lr,args.optim_type,args.max_type,args.norm_flag,args.lam,0.123 if args.gamma is None else args.gamma))
